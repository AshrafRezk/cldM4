...
**Status:** Phase A **live on the Mini** (loopback health, chat, embeddings, swap 0). [docs/operator-checklist.md](docs/operator-checklist.md) §§1–5 (Cloudflare / Neon) must be filled before Phase B. Tracker: [docs/progress.md](docs/progress.md). Implement remaining work **on the Mini**, one phase at a time.  
**Video:** out of v1.
